...
const NEEDLES=["alphas","baby boomer","babyboomer","boomers"];
(async()=>{
  ...
  for(const t of ts.docs){
    ...
    for(const m of ms.docs){
      ...
      console.log(`\n=== ${t.id} / matches/${m.id} ===`);
      console.log(JSON.stringify({team1Name:d.team1Name,team2Name:d.team2Name,team1Id:d.team1Id,team2Id:d.team2Id,
        status:d.status,bestOf:d.bestOf,team1Score:d.team1Score,team2Score:d.team2Score,scheduledTime:d.scheduledTime,
        isBracket:d.isBracket,bracketLabel:d.bracketLabel,games:d.games,team1Subs:d.team1Subs,team2Subs:d.team2Subs,
        valorantMatchId:d.valorantMatchId,lastFetchError:d.lastFetchError,
        playerStatsCount:Array.isArray(d.playerStats)?d.playerStats.length:0},null,2));
