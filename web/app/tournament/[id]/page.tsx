      ...
      {isExpanded && (() => {
        ...
        <div className="dtd-mc-expanded" style={{ background: "linear-gradient(180deg, #0A0A10 0%, #14141A 30%, #14141A 70%, #0A0A10 100%)", border: "1px solid #2A2A30", borderTop: "none", borderBottomLeftRadius: 10, borderBottomRightRadius: 10, padding: "22px 14px 18px", overflow: "hidden", position: "relative" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 4, position: "relative" }}>
                    ...
                    return (
                      <div key={pi} className="dtd-fighter-card" style={{
                        ...
                        <div style={{ textAlign: "center", maxWidth: 62 }}>
                          ...
                          {p.dotaMMR ? <div style={{ fontSize: "0.42rem", fontWeight: 600, color: "#8A8880", marginTop: 1, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{p.dotaMMR} MMR</div> : null}
                        </div>
                      </div>
                    );
                  })}
            ...
            <div className="dtd-mc-vs-col" style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 0, flexShrink: 0, animation: "dtd-vs-pop 0.6s cubic-bezier(0.16,1,0.3,1) 0.35s both", zIndex: 3, padding: "0 8px", maxWidth: 170, minWidth: 100 }}>
              {/* Team 1 Logo + Name */}
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 6, marginBottom: 10, animation: "dtd-team-name-in 0.6s cubic-bezier(0.16,1,0.3,1) 0.2s both" }}>
              ...
              <div className="dtd-mc-vs" style={{
                ...
                boxShadow: "0 0 16px rgba(161,43,31,0.2), inset 0 0 6px rgba(255,255,255,0.1)",
              }}>VS</div>
