  ...
  return (
    <>
      <style>{`
        ...
        .dt-stat-num.blue { color: #A12B1F; }
        .dt-stat-num.green { color: #4ade80; }
        .dt-stat-num.light-blue { color: #BE3A25; }
        ...
        .dt-card:hover { transform: translateY(-3px); box-shadow: 0 8px 30px rgba(161,43,31,0.15); border-color: rgba(161,43,31,0.3); }
        ...
        .dt-meta-val.prize { color: #A12B1F; }
        ...
        .dt-badge-shuffle { font-size: 0.62rem; font-weight: 800; color: #A12B1F; background: rgba(161,43,31,0.1); border: 1px solid rgba(161,43,31,0.25); border-radius: 100px; padding: 2px 10px; white-space: nowrap; }
        ...
        .dt-reg-btn { padding: 9px 22px; background: #A12B1F; color: #fff; border: none; border-radius: 100px; font-size: 0.78rem; font-weight: 800; cursor: pointer; transition: all 0.15s; white-space: nowrap; min-width: 130px; text-align: center; }
        .dt-reg-btn:hover { background: #7A1F15; box-shadow: 0 0 20px rgba(161,43,31,0.4); transform: translateY(-1px); }

        .dt-leaderboard-btn { padding: 9px 22px; background: rgba(190,58,37,0.12); color: #BE3A25; border: 1px solid rgba(190,58,37,0.3); border-radius: 100px; font-size: 0.78rem; font-weight: 800; cursor: pointer; transition: all 0.15s; white-space: nowrap; min-width: 130px; text-align: center; }
        .dt-leaderboard-btn:hover { background: rgba(190,58,37,0.2); box-shadow: 0 0 16px rgba(190,58,37,0.25); transform: translateY(-1px); }
                ...
                {tournaments.filter(t => t.status !== "ended").map((t) => {
                  ...
                  return (
                    <div key={t.id} className={`dt-card${isRegistered ? " registered" : ""}`} style={{ animationDelay: `${0.05 * tournaments.indexOf(t)}s`, position: "relative" }} onClick={() => router.push(`/tournament/${t.id}`)}>
                      ...
                      <div className="dt-card-accent" style={{ background: "#A12B1F", position: "relative", zIndex: 1 }} />
