    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        @media (max-width:600px) {
          ...
          .ie-nav-riot { display:none !important; }
      ...
      <nav className="ie-nav">
        ...
        <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
          ...
          <button className="ie-btn-steam ie-nav-riot" onClick={() => setRiotModalOpen(true)} style={{ background: "linear-gradient(135deg, #ff4655, #cc2233)", borderColor: "#ff4655" }}>
