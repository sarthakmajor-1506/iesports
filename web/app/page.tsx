    ...
    <>
      ...
      <nav className="ie-nav">
        ...
        <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
          <button className="ie-btn-steam" onClick={() => { try { sessionStorage.setItem("redirectAfterLogin", window.location.pathname); } catch {} window.location.href = "/api/auth/discord-login"; }} style={{ background: "rgba(88,101,242,0.25)", borderColor: "rgba(88,101,242,0.5)" }}>
      ...
      <section className="ie-hero" id="home">
        ...
        <div className="ie-hero-content">
          ...
          <div className="ie-hero-cta">
            ...
            <button className="ie-btn-secondary" onClick={() => { try { sessionStorage.setItem("redirectAfterLogin", window.location.pathname); } catch {} window.location.href = "/api/auth/discord-login"; }} style={{ background: "rgba(88,101,242,0.15)", borderColor: "rgba(88,101,242,0.4)" }}>
        ...
        <div className="ie-riot-overlay" onClick={(e) => { if (e.target === e.currentTarget) setRiotModalOpen(false); }}>
          <div className="ie-riot-modal">
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              <button onClick={() => { setRiotModalOpen(false); { try { sessionStorage.setItem("redirectAfterLogin", window.location.pathname); } catch {} window.location.href = "/api/auth/discord-login"; }; }} style={{
