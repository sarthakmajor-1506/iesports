      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .d2-bg-grid {
          ...
          background-image: linear-gradient(rgba(161,43,31,0.04) 1px, transparent 1px),
                            linear-gradient(90deg, rgba(161,43,31,0.04) 1px, transparent 1px);
          background-size: 64px 64px;
        }
        .d2-bg-glow1 {
          position: absolute; width: 700px; height: 700px; top: -200px; right: -100px;
          background: radial-gradient(circle, rgba(161,43,31,0.12) 0%, rgba(161,43,31,0.03) 45%, transparent 70%);
          animation: d2-glow-drift1 20s ease-in-out infinite;
        }
        .d2-bg-glow2 {
          position: absolute; width: 550px; height: 550px; bottom: 20%; left: -150px;
          background: radial-gradient(circle, rgba(161,43,31,0.09) 0%, rgba(161,43,31,0.02) 45%, transparent 70%);
        ...
        .d2-hero-title span { color: #A12B1F; }
        .d2-hero-sub {
          font-size: 0.86rem;
