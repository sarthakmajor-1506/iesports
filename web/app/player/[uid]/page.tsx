    ...
    <div className="pp-page">
      ...
      <div className="pp-content">
        <div style={{ textAlign: "center", padding: "80px 24px", maxWidth: 440, margin: "0 auto" }}>
          <div style={{ width: 64, height: 64, borderRadius: "50%", background: "rgba(88,101,242,0.12)", border: "1px solid rgba(88,101,242,0.25)", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 16px" }}>
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#818cf8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
          </div>
          <div style={{ fontSize: "1.2rem", fontWeight: 900, color: "#E6E6E6", marginBottom: 6 }}>Sign in to view profiles</div>
          <div style={{ fontSize: "0.86rem", color: "#8A8880", marginBottom: 24, lineHeight: 1.6 }}>Player profiles are available to registered users. Sign in to view stats, match history, and more.</div>
          <button
            onClick={() => {
            ...
            style={{
              ...
              border: "none", borderRadius: 100, fontSize: "0.95rem",
