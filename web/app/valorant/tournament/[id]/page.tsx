      ...
      <div className="vtd-page">
        ...
        <div className="vtd-content">
          ...
          {activeTab === "players" && (
            <div className="vtd-tab-pane" ref={tabContentRef}>
              {!user ? (
                <div className="vtd-card" style={{ textAlign: "center", padding: "48px 24px" }}>
                  <Users size={48} strokeWidth={1} style={{ margin: "0 auto 12px", display: "block", color: "#555550" }} />
                  <div style={{ fontSize: "1.1rem", fontWeight: 800, color: "#E6E6E6", marginBottom: 6 }}>Sign in to view players</div>
                  <div style={{ fontSize: "0.84rem", color: "#8A8880", marginBottom: 20 }}>Create an account to see registered players and their ranks.</div>
                  <button
                    onClick={() => {
                      try { sessionStorage.setItem("redirectAfterLogin", window.location.pathname + window.location.search); } catch {}
                      window.open("/api/auth/discord-login", "_blank");
                    ...
                    style={{
                      ...
                      border: "none", borderRadius: 100, fontSize: "0.9rem",
